...
var _user$project$App$mainStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _user$project$App$setHtml = function (txt) {
	return A2(
		_elm_lang$html$Html_Attributes$property,
		'innerHTML',
...
var _user$project$App$view = function (_p0) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$App$mainStyle,
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$App$extractContentToModel = F2(
	function (content, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				title: A2(_elm_lang$core$Maybe$withDefault, model.title, content.title),
				content: A2(_elm_lang$core$Maybe$withDefault, model.content, content.content)
			});
	});
var _user$project$App$update = F2(
	function (msg, model) {
		...
		if (_p2._0.ctor === 'Ok') {
			return {
				ctor: '_Tuple2',
				_0: A2(_user$project$App$extractContentToModel, _p2._0._0, model),
...
var _user$project$App$sendQueryRequest = function (request) {
	return A2(_jamesmacaulay$elm_graphql$GraphQL_Client_Http$sendQuery, 'http://localhost:8000/graphql', request);
};
var _user$project$App$connectionNodes = function (spec) {
...
var _user$project$App$Page = F2(
	function (a, b) {
		return {title: a, content: b};
	});
var _user$project$App$postRequest = function () {
	var uri = A3(
	...
	return A2(
		...
		{uri: 'contact-us'},
		_jamesmacaulay$elm_graphql$GraphQL_Request_Builder$queryDocument(
			_jamesmacaulay$elm_graphql$GraphQL_Request_Builder$extract(
				A3(
					_jamesmacaulay$elm_graphql$GraphQL_Request_Builder$field,
					'pageBy',
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'uri',
							_1: _jamesmacaulay$elm_graphql$GraphQL_Request_Builder_Arg$variable(uri)
						},
						_1: {ctor: '[]'}
					},
					A2(
						...
						A2(
							...
							A3(
								...
								{ctor: '[]'},
								_jamesmacaulay$elm_graphql$GraphQL_Request_Builder$nullable(_jamesmacaulay$elm_graphql$GraphQL_Request_Builder$string)),
							_jamesmacaulay$elm_graphql$GraphQL_Request_Builder$object(_user$project$App$Page)))))));
}();
var _user$project$App$Model = F4(
	function (a, b, c, d) {
		return {title: a, content: b, author: c, avatar: d};
	});
var _user$project$App$ReceiveQueryResponse = function (a) {
	return {ctor: 'ReceiveQueryResponse', _0: a};
};
var _user$project$App$sendPageQuery = A2(
	_elm_lang$core$Task$attempt,
	_user$project$App$ReceiveQueryResponse,
	_user$project$App$sendQueryRequest(_user$project$App$postRequest));
var _user$project$App$init = {
	ctor: '_Tuple2',
	_0: A4(_user$project$App$Model, '--------', '<p>fetching content ... .   .</p>', '', 'http://via.placeholder.com/120x120'),
	_1: _user$project$App$sendPageQuery
};
